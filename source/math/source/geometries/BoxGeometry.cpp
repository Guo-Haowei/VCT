 ...
 *
 */
void boxWireframe(std::vector<Vector3>& outPoints, std::vector<u32>& outIndices, float size)
{
    enum VertexIndex : u32 { A = 0, B = 1, C = 2, D = 3, E = 4, F = 5, G = 6, H = 7 };
...
void box(std::vector<Vector3>& outPoints, std::vector<u32>& outIndices, float size)
{
...
void boxWithNormal(std::vector<Vector3>& outPoints, std::vector<Vector3>& outNomrals, std::vector<u32>& outIndices, float size)
{
    outPoints.clear();
    outPoints = {
        { -size, +size, +size }, // A
